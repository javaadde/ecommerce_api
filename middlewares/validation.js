...
export const valRulesForSingUp = [
  body("username")
    .notEmpty()
    .withMessage("pleae enter The User Name")
    .isLength({ min: 3 })
    .withMessage("please take username atleast three charecters"),

  body("password")
    .isLength({ min: 6 })
    .withMessage("please choice a password that has atleast six charecres"),

  body("email").notEmpty().withMessage("please enter your email").isEmail(),
];
...
export const valRulesForProducts = [
  ...
  body("price").notEmpty().withMessage("pleae enter The price"),
